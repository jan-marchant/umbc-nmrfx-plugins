...
public class Connectivity {
    ...
    public Set<Atom> getJConnections(Atom atom) {
        ...
        for (int bonds : nBondsList) {
            HashMap<Integer,ArrayList<Atom>> bondMap= MoleculeCouplingList.getMoleculeCouplingList(mol).couplingMap2.get(atom);
    ...
    public HashMap<Atom, Set<Atom>> getJConnections (Set<Atom> atoms1, Set<Atom> atoms2) {
        ...
        MoleculeCouplingList.getMoleculeCouplingList(Molecule.getActive()).reset();
